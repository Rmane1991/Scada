...
public class PrintPDF_Ch_BatchReport extends Utility {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		/*
		 * prefs.put("savefile.default_directory", "D:\\ME_Data\\Excel\\PDF"); // Set
		 * download location prefs.put("download.prompt_for_download", false);
